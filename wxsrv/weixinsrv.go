...
func createMenu(wx *weixin.Weixin) error {
	...
	menu.Buttons[0].SubButtons[0].Name = "作业"
	menu.Buttons[0].SubButtons[0].Type = weixin.MenuButtonTypeUrl
	menu.Buttons[0].SubButtons[0].Url = "http://www.zhangleispace.club/getHo"
	menu.Buttons[0].SubButtons[1].Name = "学习资料"
	menu.Buttons[0].SubButtons[1].Url = "http://www.zhangleispace.club/getke"
	menu.Buttons[0].SubButtons[1].Type = weixin.MenuButtonTypeUrl
	menu.Buttons[0].SubButtons[2].Name = "通告"
	menu.Buttons[0].SubButtons[2].Url = "http://www.zhangleispace.club/getke"
	menu.Buttons[0].SubButtons[2].Type = weixin.MenuButtonTypeUrl
	menu.Buttons[0].SubButtons[3].Name = "学习网站"
	...
	menu.Buttons[2].SubButtons = make([]weixin.MenuButton, 2)
	menu.Buttons[2].SubButtons[0].Name = "推荐软件下载地址"
	menu.Buttons[2].SubButtons[0].Type = weixin.MenuButtonTypeKey
	menu.Buttons[2].SubButtons[0].Key = soft
	menu.Buttons[2].SubButtons[1].Name = "安装教程"
	menu.Buttons[2].SubButtons[1].Type = weixin.MenuButtonTypeKey
	menu.Buttons[2].SubButtons[1].Key = "MyKey007"
...
func Run() {
	...
	http.HandleFunc("/getke", getKeHandler)
	http.HandleFunc("/getNa", getNaHandler)
